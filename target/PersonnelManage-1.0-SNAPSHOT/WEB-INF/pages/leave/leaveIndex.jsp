...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/leaveAll',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'leaveid', width: 100, title: '编号', sort: true},
                {field: 'employeeid', width: 100, title: '工号'},
                {field: 'leavetype', width: 100, title: '休假类型'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'update') {  // 监听修改操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['50%', '95%'],
                    content: '${pageContext.request.contextPath}/queryLeaveById?id=' + data.leaveid,
                });
                ...
                layer.confirm('确定是否删除', function (index) {
                    //调用删除功能
                    deleteInfoByIds(data.leaveid, index);
                    layer.close(index);
                });
            }
        });
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['50%', '95%'],
                    content: '${pageContext.request.contextPath}/leaveAdd',
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
