...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="leavetype" lay-verify="required" lay-reqtext=""
                   placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="startdate" id="startdate" lay-verify="" autocomplete="off" class="layui-input">
        </div>
    </div>
