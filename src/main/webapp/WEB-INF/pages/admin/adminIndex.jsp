...
<%--            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="edit">修改密码</a>--%>
            <a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete">默认管理员，不可编辑</a>
        </script>
    </div>
</div>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'adminid', width: 100, title: '编号', sort: true},
                {field: 'name', width: 150, title: '姓名'},
                {field: 'gender', width: 150, title: '性别'},
                {field: 'photo', width: 150, title: '照片'},
                {field: 'contactnumber', width: 150, title: '联系电话'},
                {field: 'username', width: 150, title: '登录名'},
