...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/eventlogAll',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'logid', width: 100, title: '编号', sort: true},
                {field: 'userid', width: 100, title: '用户编号'},
                {field: 'eventtype', width: 100, title: '事件类型'},
                // {templet:'<div>{{d.typeInfo.name}}</div>',width:100,title:'图书类型'},
                {field: 'timestamp', width: 200, title: '时间戳'},
                {field: 'description', width: 150, title: '事件描述'},
                {field: 'remarks', width: 180, title: '备注'},
